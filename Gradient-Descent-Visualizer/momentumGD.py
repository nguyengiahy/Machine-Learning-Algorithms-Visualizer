...
fig1 = plt.figure("Momentum Gradient Descent")
...
# Line created by Momentum Gradient Descent
...
def GD_momentum(x_init, learningRate, iteration, gamma):
	m = A.shape[0]
	x_list = [x_init]
...
learningRate = 0.0001
gamma = 0.9
x_list = GD_momentum(x_init, learningRate, iteration, gamma)
